...
const Footer = () => {
    return (
        <div className=' mt-10 mb-10'>
            <div className='bg-gray-900  rounded-xl flex items-center justify-between gap-10'>
                <div className='pl-10'>
                    <h1 className='text-[3em] font-bold'>Never Miss an Update!</h1>
                    ...
                    <div className="flex items-center gap-4 mt-7 ">
                        ...
                        />
                        <button className="bg-[#f6ff7a] text-black px-6 py-3 rounded-xl cursor-pointer hover:bg-[#f6ff7a]/80">
                            Subscribe
                        </button>
                    </div>
            ...
            <div className='mt-[6em] flex items-center justify-between'>
                <div className=''>
                ...
                <div className='flex gap-30 '>
                    <div>
                        <h1 className='text-[1.5em] font-bold text-gray-400'>Find us</h1>
                    ...
                    <div>
                        <h1 className='text-[1.5em] font-bold text-gray-400 '>Never Miss an Update!</h1>
                        <div className="flex items-center gap-4 mt-7 ">
                            <input
                                type="text"
                                className="bg-gray-800 p-4 w-full rounded-t-lg border-b-2 border-transparent focus:outline-none focus:border-[#f6ff7a] transition-all duration-300"
