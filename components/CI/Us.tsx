  ...
  return (
    <div className='mt-20 flex flex-col items-center justify-center '>
        ...
        <div className='text-center flex flex-col gap-7'>
            <h1 className='text-[3em] font-bold'>Get Started in as Little as Two Weeks</h1>
            <p className='text-[20px] text-gray-400'>We provide a free and guaranteed estimate for cost and timeline with every engagement.</p>
        </div>


        <div className='grid grid-cols-3 gap-5 mt-15'>
           <div className='bg-gray-900 p-8 rounded-xl flex flex-col items-start gap-3 w-[400px] '>
            <Image src={"/staff.png"} alt="team" width={900} height={900} className='h-15 w-15'/>
            <h1 className='text-[2em] font-bold'>Staff Augmentation</h1>
           ...
           <div className='bg-gray-900 p-8 rounded-xl flex flex-col items-start gap-3 w-[400px] '>
            ...
            <h1 className='text-[2em] font-bold'>Product Studio</h1>
           ...
           <div className='bg-gray-900 p-8 rounded-xl flex flex-col items-start gap-3 w-[400px] '>
            ...
            <h1 className='text-[2em] font-bold'>Project Sprints</h1>
