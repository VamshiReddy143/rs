  ...
  return (
    <div className='mt-20 flex flex-col items-center justify-center '>
        ...
        <div className='text-center flex flex-col gap-7'>
            <h1 className='lg:text-[3em] text-[2em]  font-bold text-center'>Get Started in as Little as Two Weeks</h1>
        ...
        <div className='grid lg:grid-cols-3 grid-cols-1 gap-5 mt-15'>
           <div className='bg-gray-900 lg:p-8 p-4 rounded-xl flex flex-col items-start gap-3 '>
           ...
           <div className='bg-gray-900 lg:p-8 p-4 rounded-xl flex flex-col items-start gap-3  '>
            ...
            <h1 className='lg:text-[2em] text-[1.5em] font-bold'>Project Sprints</h1>
