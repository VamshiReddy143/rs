...
const Us = () => {
  return (
    ...
    <div className='text-center flex flex-col lg:gap-9 gap-2'>
        ...
        <p className='lg:text-[16px] text-[16px] leading-[32px] text-[#bcbcc0] text-center'>We provide a free and guaranteed estimate for cost and timeline with every engagement.</p>
    </div>



        <div className='grid lg:grid-cols-3 grid-cols-1 gap-5 mt-15'>
           <div className='bg-[#242425]  lg:p-8 p-4 rounded-xl flex flex-col items-start gap-3 '>
           ...
           <div className='bg-[#242425]  lg:p-8 p-4 rounded-xl flex flex-col items-start gap-3  '>
            ...
            <h1 className='lg:text-[24px] text-[1.5em] font-bold'>Project Sprints</h1>
