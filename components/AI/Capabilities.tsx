...
const Capabilities = () => {
  return (
    <div className="mt-2 lg:mt-4 min-h-[auto] lg:min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-0">
      <div className="flex flex-col items-center justify-center gap-2 py-10 text-center">
        <h1 className="text-[1.8em] sm:text-[2.2em] lg:text-[2.4em]  font-bold">
          Our Capabilities
        </h1>
        <p className="text-gray-400 text-[0.9em] sm:text-[1em] lg:text-[1.2em] max-w-2xl">
          We're proud to offer exceptional talent across a variety of digital disciplines.
        </p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-7 !important w-full mt-5 max-w-7xl">
