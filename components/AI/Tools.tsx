    ...
    <div className='lg:pt-10 flex pt-[4em] flex-col items-center justify-center gap-7'>
        ...
        <div className='flex gap-7  flex-wrap  items-center justify-center'>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/ten.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
                <span className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>Tensor Flow</span>
            </div>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/star.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
                <p className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>Apache Spark</p>
            </div>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/gpt.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
                <p className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>OpenAI</p>
            </div>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/meta.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
                <p className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>Llama</p>
            </div>
            
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/lc.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
            ...
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/sora.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
