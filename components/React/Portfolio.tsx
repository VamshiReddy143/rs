...
const Portfolio = () => {
    return (
        <div className="flex flex-col items-center justify-center gap-6 lg:pt-[8em] pt-[7em]">
            <h1 style={{ fontFamily: 'Poppins, sans-serif' }} className="lg:text-[36px] text-[36px] font-semibold text-center">
                Our Portfolio: <span className="block lg:inline">React</span>
            </h1>
            ...
            <div className="grid lg:grid-cols-3 grid-cols-1  gap-10 lg:mt-10 mt-5">
                ...
                <div>
                    <div
                        className="card h-[500px]   group gap-[0.5em] rounded-[1.5em] relative flex justify-end flex-col p-[1.5em] z-[1] overflow-hidden"
                        style={{
                            backgroundImage: "url('/reactimg2.jpg')",
                            backgroundSize: 'cover',
                            backgroundPosition: 'center',
                        }}
                    >
                ...
                <div>
                    <div
                        className="card  h-[500px]   group gap-[0.5em] rounded-[1.5em] relative flex justify-end flex-col p-[1.5em] z-[1] overflow-hidden"
                        style={{
                            backgroundImage: "url('/reactimg3.jpg')",
                            backgroundSize: 'cover',
                            backgroundPosition: 'center',
                        }}
                    >
                        ...
                        <div className="container text-white z-[2] relative  flex flex-col gap-[0.5em]">
                            <div className="h-fit w-full">
                                <p style={{ fontFamily: 'Poppins, sans-serif' }} className="text-[24px] font-semibold ">
                                    Engaging & Managing a Global Workforce
                                </p>
                            </div>
                        </div>
                        <div className='absolute top-10 left-9 z-[2]'>
