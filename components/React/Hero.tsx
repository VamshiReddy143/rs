...
const page = () => {
    return (
      ...
      <h1 style={{ fontFamily: 'Poppins, sans-serif' }} className="lg:text-[64px] md:text-[56px] text-[40px]  font-bold">
                Accelerate Your React<span className="lg:block"> Roadmap</span>
                </h1>
                <p className="mt-5 text-[16px] text-[#bcbcc0] lg:w-[89%] md:w-[70%] leading-[1.9]">
                We consistently deliver expert React engineering services for partners across projects as complex as dynamic, data-rich web applications and as simple as static landing pages.
