...
const page = () => {
    return (
      ...
      >
            ...
            <div className="flex flex-col items-start lg:w-[60%] w-full lg:pb-20 md:pb-[20em] justify-center h-screen leading-tight">
            <h1 style={{ fontFamily: 'Poppins, sans-serif' }} className="lg:text-[64px] md:text-[56px] text-[40px]  font-bold">
                ...
                <p className="mt-5 text-[16px] text-[#bcbcc0] lg:w-[90%] md:w-[70%] leading-[1.9]">
                We deliver exceptional Data Engineering & Data Science services for partners across diverse projects. Our expertise ensures your data is accurate, accessible, and actionable, empowering your business with insights that drive real-time decisions and optimize performance at scale.
                </p>
                <Link href={"/Contact"}>
