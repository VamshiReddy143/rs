    ...
    <p className='text-[#bcbcc0] text-center text-[16px]'>We are expert practitioners and community leaders in the industry&apos;s leading technologies.</p>
        ...
        <div className='flex lg:gap-9  gap-5 flex-wrap  items-center justify-center'>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/snowflake.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
                <span className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>Snowflake</span>
            </div>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/databricks.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
                <p className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>DataBricks</p>
            </div>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/apache.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
            ...
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/kue.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-10 w-10'/>
