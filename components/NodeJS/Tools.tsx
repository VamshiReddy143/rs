  ...
  return (
    ...
    <div className='flex gap-6  flex-wrap  items-center justify-center'>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/express.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-15 w-15'/>
                <span className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>Express</span>
            </div>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/nestjs.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-15 w-15'/>
                <span className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>NestJS</span>
            </div>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/socket.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-15 w-15'/>
                <span className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>Socket.io</span>
            </div>
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/pm2.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-15 w-15'/>
                <span className='lg:text-[13px] text-[#bcbcc0] text-[0.7em]'>PM2</span>
            </div>
            
            <div className='flex flex-col items-center justify-center'>
                <Image src={"/jest.svg"} alt="tools" width={900} height={900} className='lg:h-[56px] lg:w-[56px] h-15 w-15'/>
