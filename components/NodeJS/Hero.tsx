...
const page = () => {
    return (
      ...
      <h1 style={{ fontFamily: 'Poppins, sans-serif' }} className="lg:text-[64px] md:text-[56px] text-[40px]  font-bold">
                Accelerate Your Node<span className="lg:block">Roadmap</span>
                </h1>
                <p className="mt-5 text-[16px] text-[#bcbcc0] lg:w-[89%] md:w-[70%] leading-[1.9]">
                We consistently deliver top-tier Node.js engineering services for partners across a wide range of projects. Our expertise is perfect for real-time applications and operating in complex, data-intensive environments because we always optimize for performance and scalability.
