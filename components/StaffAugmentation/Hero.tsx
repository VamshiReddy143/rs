...
const page = () => {
    return (
        ...
        <div
            className="bg-black text-white flex justify-between overflow-hidden min-h-screen bg-no-repeat bg-[position:calc(100%)] bg-[length:900px] bg-[url('/sasimg.png')]"
        >
            <div className="flex flex-col items-start  justify-center h-screen leading-tight">
                <div className='lg:flex justify-between items-center '>
                    ...
                    <div className='bg-gray-900 border-2 border-[#3b9b58] rounded-xl p-4 lg:w-[35%] w-full lg:mr-50 mr-0'>
