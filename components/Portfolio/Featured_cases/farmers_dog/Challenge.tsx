    ...
    <div style={{ fontFamily: 'Poppins, sans-serif' }} className='bg-[#203a33] text-white'>
        <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 lg:py-[12em] py-[5em] md:flex gap-[5em] items-center'>
              <div>
               ...
               <p className='lg:text-[32px] font-medium lg:leading-[38px]'>The</p>
               <h1 className='font-medium lg:leading-[77px] lg:text-[64px] text-[3em]'>Challenge</h1>
               </div>
                <div className='h-[2px] w-[60px] bg-white rounded-full lg:mt-9 mt-5'/>
                <p className='lg:text-[22px] text-[20px] lg:leading-[36px] leading-[30px] font-normal  lg:pt-4 pt-10'>
        ...
        <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 lg:py-[16em] py-[4em]  md:flex gap-[5em] items-center'>
            <h1 className='lg:text-[72px] text-[36px] leading-[43px] lg:leading-[86px] font-sans font-normal'>
