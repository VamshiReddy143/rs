    ...
    <div style={{ fontFamily: 'Poppins, sans-serif' }} className='bg-gray-200 text-black min-h-screen '>
        ...
        <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 lg:mt-[12em] mt-10 md:flex gap-[5em] items-center'>
            <div className='flex flex-col items-start lg:gap-2'>
                <p className='lg:text-[32px] font-medium lg:leading-[38px] text-[1.5em] '>About</p>
                <h1 className='lg:text-[64px] font-medium lg:leading-[77px] text-[2.5em] '>the <span className='lg:block'>Client</span></h1>
                <div className='w-[50px] h-[2px] mt-5 bg-black'/>
            </div>

            <div className='lg:mt-0 mt-[2em]'>
                <p className='lg:text-[24px] lg:leading-[36px] text-[18px] leading-[26px] font-normal  text-[1.2em]'>
            ...
            <div className='lg:max-w-[90em] mx-auto lg:px-[4em] px-3 lg:mt-[20em] mt-[10em] lg:pb-[10em] pb-[5em]'>
                <h1 className='lg:text-[80px] text-[42px] leading-[50px] font-medium lg:leading-[96px]'>
                ...
                <div className='lg:mt-[4em] mt-[2em]'>
                    <p className=' lg:text-[28px] font-normal lg:leading-[42px] text-[1em]'>Ashley VanderWel</p>
                    <p className='lg:text-[28px] font-normal lg:leading-[42px] text-[1.2em] text-[#f1684a]'>Sr Director of Engineering</p>
                </div>
            </div>
    </div>
  )
