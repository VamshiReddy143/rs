...
const Hero = () => {
  ...
  return (
    <div ref={sectionRef} className="min-h-screen bg-[#203a33] flex flex-col pb-11 items-center justify-center">
      <div className="lg:mt-[15em] mt-[10em] text-center">
        ...
        <div className="mt-10 flex flex-col items-start lg:px-[10em] px-4">
          ...
          <div className="lg:flex justify-between w-full">
            ...
            <div className="pb-10"> 
              <h1 className="lg:text-[2.5em] text-[1.4em] text-white text-left lg:text-center mt-5">
                The Team
              </h1>
