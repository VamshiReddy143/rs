  ...
  return (
    <div style={{ fontFamily: 'Poppins, sans-serif' }} className='min-h-screen bg-gray-200 text-black'>
        <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 lg:py-[10em] py-[7em]'>
            <h1 className='lg:text-[56px] leading-[84px] font-[400] text-[2em] leading-tight  lg:w-[60%]'>Our proposed system architecture is decoupled, fault-tolerant, scalable, and enables traceability.</h1>
        </div>
        ...
        <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 py-[8em]'>
            <h1 className='lg:text-[56px] leading-[84px] font-[400] text-[2em]  text-right lg:pl-[7em] '>It allows for re-training and ensures data transparency and monitorability.</h1>
        </div>
        ...
        <div className='lg:max-w-[93em] mx-auto lg:px-[6em] px-3 py-[10em]'>
            <h1 className='lg:text-[72px] leading-[86px] font-medium text-[2em] '>
