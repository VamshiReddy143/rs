  ...
  return (
    <div style={{ fontFamily: 'Poppins, sans-serif' }} className='bg-gray-200 text-black min-h-screen '>
              ...
              <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 lg:pt-[10em] pt-[4em] gap-[5em] items-center'>
                 <h1 className='lg:text-[64px]  text-[2em] leading-[77px] font-medium'>Transforming Cattle Health with AI-Enhanced Lameness Detection</h1>
                 <p className='lg:pt-[5em] pt-[3em] lg:text-[32px] leading-[48px] font-extralight text-[1.2em] lg:w-[75%]'>
            ...
            <div className='flex flex-col items-start gap-1'>
                <p className='lg:text-[32px] text-[1.5em] font-medium leading-medium'>The</p>
                <h1 className='lg:text-[64px] text-[2em] leading-[77px] font-semibold'>challenge</h1>
