...
const Hero = () => {
  ...
  return (
    <div ref={sectionRef} className="min-h-screen bg-[#b84d00]">
      <div className="lg:max-w-[90em] mx-auto lg:px-[4em] px-3">
        <h1 className="lg:text-[2.6em] text-[1.7em] text-center font-semibold lg:pt-[6em] pt-[5em]">
          Leading the Future of <span>Livestock Health</span> with Advanced AI Technology.
        </h1>
        <video
          ref={videoRef}
          src="/videos/cow.mp4"
      ...
      <div className="mt-10 flex flex-col items-start lg:px-[10em] lg:pb-[10em] px-4">
        <h1 className="lg:text-[5em] text-[2em] font-bold text-white leading-tight">
        ...
        <div className="lg:flex justify-between w-full mt-10">
          <div className="flex flex-col items-start">
            ...
            <div className="md:flex items-center gap-10 mt-4">
              <div className="flex flex-col items-start gap-5">
                ...
                <p className="border border-white py-2 px-6 rounded-xl w-fit lg:text-[1.4em] text-[1em]">
                  Proof of concept
                </p>
              </div>
              ...
              <div className="flex flex-col items-start gap-5 md:mt-0 mt-5">
                ...
                <div className="flex lg:gap-5 gap-2">
                  <p className="border border-white py-2 px-3 rounded-xl w-fit lg:text-[1.4em] text-[1em]">
                    Health
                  </p>
                  <p className="border border-white py-2 px-3 rounded-xl w-fit lg:text-[1.4em] text-[1em]">
                    Veterinary
          ...
          <div className="pb-10"> 
            <h1 className="lg:text-[2.5em] text-[1.5em] text-white text-left lg:text-center mt-5">
              The Team
            </h1>
