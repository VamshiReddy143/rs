    ...
    return (
        <div style={{ fontFamily: 'Poppins, sans-serif' }} className='bg-gray-200 text-black '>
            ...
            <div className='lg:max-w-[95em] mx-auto lg:px-[6em] px-3 lg:py-[10em] py-[5em] md:flex gap-[5em] items-center'>
                ...
                <h1 className='lg:text-[64px] text-[2.5em] leading-[77px]   font-medium'>Elevating</h1>
                    <h1 className='lg:text-[64px] text-[2.5em] leading-[77px] font-medium'>Cattle Health</h1>
                    <h1 className='lg:text-[64px] text-[2.5em] leading-[77px] font-medium'>Management</h1>
                   
                </div>

                <div className='lg:mt-0 mt-[2em]'>
                    <p className='lg:text-[24px] font-normal leading-[36px] text-[1.2em]'>
