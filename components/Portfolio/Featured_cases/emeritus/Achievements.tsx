      ...
      <div className='lg:max-w-[90em] mx-auto text-black  lg:px-[6em] px-3 lg:mt-[12em] lg:pt-[1em]  gap-[5em] items-center pb-[10em]'>
        ...
        <div className='mt-10 flex flex-col gap-7'>
          <div className='flex gap-4 items-start'>
            ...
            <p className='lg:text-[37px] leading-[48px] font-normal text-[1.5em] '>Developing new back and frontends on higher-performing Ruby on Rails and React applications.</p>
          </div>
          <div className='flex gap-4 items-start'>
            <h1 className='lg:text-[2em] text-[1.5em]'>●</h1>
            <p className='lg:text-[37px] leading-[48px] font-normal text-[1.5em]'>Implementing a single sign-on flow (SSO) to improve the Enrollment Engine functionality.</p>
          </div>

          <div className='flex gap-4 items-start'>
            <h1 className='lg:text-[2em] text-[1.5em]'>●</h1>
            <p className='lg:text-[37px] leading-[48px] font-normal text-[1.5em]'>Launching subdomains for unique white-label experiences with university partners.</p>
          </div>
