...
const Hero = () => {
  ...
  return (
    <div ref={sectionRef} className="min-h-screen bg-red-700  ">
      <div className="lg:pt-[15em] pt-[7em] text-center lg:max-w-[90em]  lg:px-[6em] px-3 mx-auto">
        <div>
          <h1 className="lg:text-[2.3em] text-[1.7em] font-semibold text-white">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="md:flex items-center gap-10 mt-4">
                <div className="flex flex-col items-start gap-5">
                  ...
                  <p className="border border-white py-2 px-6 rounded-xl w-fit lg:text-[1.4em] text-[1.2em]">Staff Augmentation</p>
                </div>
                ...
                <div className="flex flex-col items-start gap-5 md:mt-0 mt-5">
                  ...
                  <div className="flex gap-5">
                    <p className="border border-white py-2 px-6 rounded-xl w-fit lg:text-[1.4em] text-[1.2em]">Education</p>
                    <p className="border border-white py-2 px-6 rounded-xl w-fit lg:text-[1.4em] text-[1.2em]">Streaming</p>
                  </div>
                </div>
              </div>
