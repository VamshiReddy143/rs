    ...
    <div style={{ fontFamily: 'Poppins, sans-serif' }}   className='bg-gray-200 text-black min-h-screen '>
        ...
        <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 mt-[3em] md:flex gap-[5em] items-center'>
            <div className='flex flex-col items-start gap-2'>
                ...
                <div className='w-[50px] h-[2.5px] bg-black'/>
            </div>
            ...
            <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 lg:mt-[20em] mt-[10em] pb-[10em]'>
                <h1 className='lg:text-[63px] text-[2em] font-medium leading-[81px]'>“We don't treat them like an outsourced team. They're <span className='text-red-700'>part of our big team</span>. They contribute to all our code initiatives.”</h1>
