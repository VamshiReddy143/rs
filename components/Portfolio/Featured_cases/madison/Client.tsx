    ...
    <div style={{ fontFamily: 'Poppins, sans-serif' }} className=' bg-[#212121] '>
        ...
        <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 py-[10em] md:flex gap-[5em] bg-[#212121]  text-white items-center'>
            <div className='flex flex-col items-start lg:gap-2'>
                ...
                <h1 className='lg:text-[64px] text-[2.5em] lg:leading-[77px] font-medium'>the <span className='lg:block'>Client</span></h1>
                <div className='w-[60px] h-[2px] bg-white mt-3'/>
            </div>

            <div className='lg:mt-0 mt-[2em]'>
                <p className='lg:text-[24px] lg:leading-[36px] font-normal text-gray-100 text-[18px] leading-[26px]'>
