    ...
    <div style={{ fontFamily: 'Poppins, sans-serif' }} className='bg-gray-200 text-black min-h-screen '>
        ...
        <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 lg:pt-[12em] pt-10 md:flex gap-[5em] items-center'>
            <div className='flex flex-col items-start gap-2'>
                <p className='lg:text-[32px] leading-[38px] font-medium text-[1.5em] '>About</p>
                <h1 className='lg:text-[64px] text-[2.5em] leading-[77px] font-medium flex gap-5'>the <span className=''>Client</span></h1>
                <div className='w-[50px] h-[2px] bg-black'/>
            </div>

            <div className='lg:mt-0 mt-[2em]'>
                <p className='lg:text-[25px] font-normal leading-[42px] text-[1.2em]'>
            ...
            <div className='lg:max-w-[90em] mx-auto lg:px-[4em] px-3 lg:mt-[18em] mt-[10em] lg:pb-[10em] pb-[6em]'>
                <h1 className='lg:text-[67px] font-medium  text-[2em]  leading-[81px'>
                ...
                <div className='lg:mt-[4em] mt-[2em]'>
                    <p className=' lg:text-[28px] font-normal leading-[43px] text-[1em]'>Julie DeLoyd</p>
                    <p className='lg:text-[28px] font-normal leading-[43px] text-[1em]'>President, Brightwheel</p>
                </div>
            </div>
    </div>
  )
