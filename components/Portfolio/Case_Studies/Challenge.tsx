    ...
    return (
        <div style={{ fontFamily: 'Poppins, sans-serif' }} className='bg-[#1B1B1B] text-white'>
            ...
            <div className='lg:max-w-[90em] mx-auto lg:px-[4em] px-3 lg:pt-[12em] py-[6em] leading-tight '>
                ...
                <p className='lg:text-[28px] font-extralight  text-[1.3em] mt-10'>
                ...
                <div className='lg:mt-10 mt-7 '>
                    ...
                    <div className='flex flex-col gap-10 mt-10'>
                        ...
                        <div className='flex gap-4 items-start'>
                            <h1 className='lg:text-[1.5em] text-[1.3em]'>●</h1>
                            <p className='lg:text-[2em] text-[1.2em] '><span className='font-semibold'>Trust & Growth on the Web: </span><span className='lg:text-[28px] font-extralight  text-[1.3em] '>
