    ...
    return (
        <div className='bg-white text-black'>
            <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 lg:pt-[12em] pt-[5em] pb-[10em] lg:flex justify-between items-center gap-[2em]'>
                <div>
                    <h1 className='lg:text-[3.3em] text-[2.7em] font-semibold'>The <span className='lg:block'>Results</span></h1>
                    <div className='h-[3px] w-[80px] bg-black rounded-full mt-5' />
                </div>
                <div className='flex flex-col gap-10 mt-10 lg:mt-0 '>
                    <div className='flex gap-4 items-start'>
                        <h1 className='lg:text-[1.5em] text-[1.3em] mt-1'>●</h1>
                        <p className='lg:text-[2em] text-[1.2em] '><span className='font-bold'>#1 Childcare Software: </span><span className=' '> 
                    ...
                    <div className='flex gap-4 items-start'>
                        <h1 className='lg:text-[1.5em] text-[1.3em] mt-1'>●</h1>
                        <p className='lg:text-[2em] text-[1.2em] '><span className='font-bold'>Improved Productivity:</span><span className=' '> 
                    ...
                    <div className='flex gap-4 items-start'>
                        <h1 className='lg:text-[1.5em] text-[1.3em] mt-1'>●</h1>
                        <p className='lg:text-[2em] text-[1.2em] '><span className='font-bold'>Recognition & Investment: </span><span className=' '> 
