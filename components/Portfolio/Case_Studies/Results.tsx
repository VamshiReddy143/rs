            ...
            <div className='lg:max-w-[90em] mx-auto lg:px-[6em] px-3 lg:pt-[12em] pt-[5em] pb-[10em] lg:flex justify-between items-center gap-[2em]'>
                ...
                <div className='flex flex-col gap-10 mt-10 lg:mt-0 '>
                    <div className='flex gap-4 items-start'>
                        ...
                        <p className='lg:text-[28px] text-[1.2em] '><span className='font-semibold'>#1 Childcare Software: </span><span className='font-normal '> 
                    ...
                    <div className='flex gap-4 items-start'>
                        <h1 className='lg:text-[1.5em] text-[1.3em] mt-1'>●</h1>
                        <p className='lg:text-[28px] text-[1.2em] '><span className='font-semibold'>Improved Productivity:</span><span className='font-normal '> 
                    ...
                    <div className='flex gap-4 items-start'>
                        <h1 className='lg:text-[1.5em] text-[1.3em] mt-1'>●</h1>
                        <p className='lg:text-[28px] text-[1.2em] '><span className='font-semibold'>Recognition & Investment: </span><span className='font-normal '> 
